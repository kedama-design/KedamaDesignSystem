...
import {
  ...
  ThemeProvider, ThemeToggle, IconSwap, RollingText,
  Drawer, DrawerContent, Table, TableBody, TableRow, TableCell,
  Skeleton, Spinner, Toaster, toast, cn,
} from '@kedama-design/design-system';
import { semanticColors, elevation, spacing, semanticMotion } from '@kedama-design/design-system/tokens';
  ...
  return (
    <ThemeProvider defaultTheme={choice}>
      <div className={cn('p-4')} style={{ gap: spacing[4] }}>
        ...
        <Table><TableBody><TableRow><TableCell>セル</TableCell></TableRow></TableBody></Table>
        <Drawer open={false}><DrawerContent>x</DrawerContent></Drawer>
        <Toaster />
...
// トークンが値として読めること
console.log(semanticColors.fg.default, elevation.overlay, semanticMotion['value-change'].tween.duration);
